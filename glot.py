...
# Get images
X = []
for filename in os.listdir('./oo/'):
    X.append(img_to_array(load_img('./oo/'+filename)))
...
model.fit_generator(image_a_b_gen(batch_size), epochs=10, steps_per_epoch=1, callbacks=callbacks_list, verbose=1)
